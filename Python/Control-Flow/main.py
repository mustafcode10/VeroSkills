...
# Write a series of if statements to test your understanding of logic.
# change or and and in the code and try to predict the output.

# Peseudo code variable num  and check if the number is even  than print even else print odd
